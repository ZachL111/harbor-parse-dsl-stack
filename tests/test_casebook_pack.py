"""Regression checks for the harbor-parse-dsl-stack casebook."""
...
from casebook.harness import assert_expected, harbor_parse_dsl_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(harbor_parse_dsl_stack_summary(), assert_expected())
